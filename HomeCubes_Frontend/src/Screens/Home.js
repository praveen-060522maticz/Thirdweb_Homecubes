        ...
        <Container className="custom_container ">
          <Row>
            ...
            <Col lg={11} md={10} sm={12} xs={12} className="res_pad_aligner">
              <Row>
                <Col lg={12} sm={12}>
                  <Row className="justify-content-between home_banner_row align-items-center">
                    <Col lg={6} md={6} sm={12} xs={12} className="mb-3">
                      <div className="home_bannerleft">
                        ...
                        <NavLink to="/howitworks">
                          <button className="primary_blueBtn home_bannerPrimay mt-5">
                            How it works
                          </button>
                        </NavLink>
                      </div>
                  ...
                  <Row className="pi_higherTop align-items-center">
                    ...
                    >
                      ...
                      {CMS["CountDown to Our Next Launch"]?.img && <div className="anim_div">
                        ...
                        <LottieAnimation url={`${config.IMG_URL}/cmsimg/${CMS["CountDown to Our Next Launch"]?.img}`} />
                      </div>}
                      {/* <img
                            className="img-fluid"
                  ...
                  <Row className="align-items-center pi_higherTop">
                    <h3
                      className="home_titled text-center mb-5"
                      data-aos="fade-up"
                      data-aos-offset="50"
                      data-aos-duration="800"
                    >
                      ...
                      <Col lg={8} className="home_mailer">
                        <Row className="justify-content-center">
                          <Col
                            ...
                            sm={10}
                            xs={11}
                            className="my-5 d-flex justify-content-center align-items-center gap-3"
                          >
                            <img
                              src={require("../assets/images/linktree.png")}
                              className="img-fluid home__linktreeImg"
                            />
                            <h3
                              className="home_titled text-center"
                              data-aos="fade-up"
