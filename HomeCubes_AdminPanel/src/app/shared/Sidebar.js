            ...
            <Collapse in={true}>
              <div>
                <ul className="nav flex-column sub-menu">
                  ...
                  {LSgetItem("adminType") == adminList[0] && <li className="nav-item"> <Link className={this.isPathActive('/refferalFee') ? 'nav-link active' : 'nav-link'} to="/refferalFee"><Trans>Refferal Fees Management</Trans></Link></li>}
