...
export default function RoyaltyReport(props) {
    ...
    const getGalleryData = async () => {
        try {
            var resp = await getReportsFunc({ action: "royaltyReport", ...state });
                    ...
                    <div className="col-lg-12 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">Royalty Report</h4>
