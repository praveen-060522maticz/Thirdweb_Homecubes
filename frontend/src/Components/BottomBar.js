                ...
                <Container >
                    <div className='d-flex justify-content-between align-items-center'>
                        ...
                        <NavLink to="/marketplace" className="sidetab_link">
                            <div className='bottombar_single'>
                                <img className='bottombar_img' src={require('../assets/images/marketplace_greens.svg').default} />
                                <p className='bottombar_label mt-1'>Marketplace</p>
                            </div>
                        </NavLink>
                        <NavLink to="/staking" className="sidetab_link">
                            <div className='bottombar_single'>
                                <img className='bottombar_img' src={require('../assets/images/claim_green.svg').default} />
                                <p className='bottombar_label mt-1'>Claim Income</p>
                            </div>
                        </NavLink>
                        <NavLink to="/projects" className="sidetab_link">
                            <div className='bottombar_single'>
                                <img className='bottombar_img' src={require('../assets/images/property_green.svg').default} />
                                <p className='bottombar_label mt-1 bottombar_alignlabel'>Properties</p>
                            </div>
                        </NavLink>
