...
if (EnvName === "demo") {
    ...
    key.FRONT_URL = 'https://homecube.maticz.in/'
    key.BACK_URL = 'https://homecubesbackend.maticz.in//v1/front'
    key.ADMIN_URL = 'https://homecubesbackend.maticz.in//v1/admin'
    key.IMG_URL = 'https://homecubesbackend.maticz.in'
    ...
    // key.TradeContract = "0x06634158F0a6fdb7686b67d128d5b8d498349cD9".toLowerCase(); // audit bsc testnet
    key.TradeContract = "0xeA7AE9464eF470DBbD43488F0875FD54521576b1".toLowerCase(); // Test removed openzepline bnb
    ...
    key.KEY = process.env.REACT_APP_SECKEY
    key.FRONT_URL = 'https://app.homecubes.io/'
